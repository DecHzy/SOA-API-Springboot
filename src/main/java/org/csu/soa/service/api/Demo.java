package org.csu.soa.service.api;

import com.alibaba.fastjson.JSONObject;
import org.csu.soa.service.api.util.Base64;
import org.csu.soa.service.api.util.WebUtils;
...
public class Demo {
	...
	public static void ip(String adfas[]) throws Exception {
		byte b[]=new ShowapiRequest("https://ali-ip.showapi.com/ip","appcode")
			.addTextPara("org/csu/soa/service/ip", "223.5.5.5")
				.getAsByte();
		String str=new String(b,"utf-8");
		System.out.println(str);
	}
